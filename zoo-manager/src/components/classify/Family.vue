<template>
    <div>
        <el-breadcrumb separator="/">
            ...
            <el-breadcrumb-item>科</el-breadcrumb-item>
        </el-breadcrumb>
        ...
        <el-card class="box-card">
            <el-form :model="queryParams" ref="queryParams" :inline="true">
                ...
                <el-form-item prop="orders">
                    <el-select @change="getOrders(queryParams.orders)" v-model="queryParams.orders" filterable remote clearable reserve-keyword placeholder="选择目名">
                        <el-option v-for="(name, index) in orders" :key="index" :label="name" :value="name"></el-option>
                    </el-select>
                </el-form-item>

                <el-form-item prop="family">
                    <el-select v-model="queryParams.family" filterable remote clearable reserve-keyword placeholder="输入科"></el-select>
                </el-form-item>
        ...
        <el-dialog class="classify" title="修改增加" :visible.sync="editVisible" :width="width" :before-close="handleClose">
            <el-card style="text-align: left;">
                ...
                <el-input class="vertical-interval" type="text" placeholder="请输入科名" v-model="editParam.family" maxlength="10" show-word-limit>
                </el-input>
...
export default {
  ...
  methods: {
    ...
    selectList () {
      this.getTotal()
      this.$http.post(this.$host + 'animal/select/kind/family', this.queryParams
      ).then(res => {
    ...
    getTotal () {
      this.$http.post(this.$host + '/animal/select/count/family', this.queryParams).then(res => {
          if (res.data.code == 200) {
