<template>
    <div>
        <el-breadcrumb separator="/">
            ...
            <el-breadcrumb-item>属</el-breadcrumb-item>
        </el-breadcrumb>
        ...
        <el-card class="box-card">
            <el-form :model="queryParams" ref="queryParams" :inline="true">
                ...
                <el-form-item prop="family">
                    <el-select v-model="queryParams.family" filterable remote clearable reserve-keyword placeholder="选择科名">
                        <el-option v-for="(name, index) in family" :key="index" :label="name" :value="name"></el-option>
                    </el-select>
                </el-form-item>

                <el-form-item prop="genus">
                    <el-select v-model="queryParams.genus" filterable remote clearable reserve-keyword placeholder="输入属"></el-select>
                </el-form-item>
            ...
            <el-table :data="data" border style="width: 100%">
                ...
                <el-table-column prop="orders" label="目名" width="150"></el-table-column>
                <el-table-column prop="family" label="科名" width="150"></el-table-column>
                <el-table-column prop="genus" label="属名" width="150"></el-table-column>
        ...
        <el-dialog class="classify" title="修改增加" :visible.sync="editVisible" :width="width" :before-close="handleClose">
            <el-card style="text-align: left;">
                ...
                <div class="el-input el-input--medium el-input-group el-input-group--prepend vertical-interval">
                    ...
                    <el-select @change="getOrders(editParam.orders)" v-model="editParam.orders" filterable remote clearable reserve-keyword placeholder="选择目名">
                        <el-option v-for="(name, index) in orders" :key="index" :label="name" :value="name"></el-option>
                    </el-select>
                </div>
                ...
                <div class="el-input el-input--medium el-input-group el-input-group--prepend vertical-interval">
                    ...
                    <el-select @change="getFamily(editParam.family)" v-model="editParam.family" filterable remote clearable reserve-keyword placeholder="选择科名">
                        <el-option v-for="(name, index) in family" :key="index" :label="name" :value="name"></el-option>
                    </el-select>
                </div>
                
                <el-input class="vertical-interval" type="text" placeholder="请输入属名" v-model="editParam.genus" maxlength="10" show-word-limit>
                </el-input>
...
export default {
  ...
  methods: {
    ...
    selectList () {
      this.getTotal()
      this.$http.post(this.$host + 'animal/select/kind/genus', this.queryParams
      ).then(res => {
    ...
    getTotal () {
      this.$http.post(this.$host + '/animal/select/count/genus', this.queryParams).then(res => {
          if (res.data.code == 200) {
